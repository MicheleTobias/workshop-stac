...
In this workshop, we'll use the [NASA's Earthdata](https://www.earthdata.nasa.gov/) repository to learn how to:
...
To get access to NASA Earthdata, sign up for an Earthdata Login account: <https://urs.earthdata.nasa.gov/>
...
## Search Harmonized Landsat Sentinel (HSL) Data
...
Then it's time do setup our STAC search parameters: STAC URL, collection name, bbox, time interval, and limit how many items we want to find.
...
Create we have 12 results. Let's inspect the first element of the results to see what it looks like.
